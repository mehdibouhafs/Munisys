...
public class AdaptorForSiteInventory extends RecyclerView.Adapter<AdaptorForSiteInventory.MyViewHolder> implements Filterable {
    ...
    public AdaptorForSiteInventory(ArrayList<Inventaire> list_don, Context ctx) {
