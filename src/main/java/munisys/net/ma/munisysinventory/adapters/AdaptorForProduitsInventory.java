...
public class AdaptorForProduitsInventory extends RecyclerView.Adapter<AdaptorForProduitsInventory.MyViewHolder> implements Filterable {
    ...
    public AdaptorForProduitsInventory(ArrayList<Inventaire> list_don, Context ctx) {
